...
public abstract class FluidIOPortEntity extends PartBaseEntity implements ExtendedScreenHandlerFactory, IUpgradeEntity {
...
//                        || stack.isOf(NIOItems.SPEED_UPGRADE_5.get());
    ...
    public FluidIOPortEntity(PartBaseItem item, NIOBaseBlockEntity blockEntity, Direction direction) {
